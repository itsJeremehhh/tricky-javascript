...
function createAccount(pin, amount = 0) {
    //wouldnt creat account be a class? and then we make methods before returning?

    //you can return a function like below?
    return {
        ...
        deposit(inputPin, newAmount) {
            if (inputPin !== pin) return "Invalid PIN";
            amount += newAmount;
            return `Sucessfully deposited $${newAmount}. Current balance: $${amount}.`;
        },
